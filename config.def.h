...
/* commands */
static const char *dmenucmd[] = { "dmenu_run", "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan1, "-sf", col_gray4, "-shb", col_cyan2, topbar ? NULL : "-b", NULL };
...
static const char *togglmed[] = { "playerctl", "play-pause", NULL };
